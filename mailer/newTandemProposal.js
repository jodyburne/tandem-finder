const newMessageTemplate = function(tandemCreatorName) {
return `
...
@media only screen and (max-width:480px) {
  ...
  >
    <p><span style="color:#F57816;"><span style="font-size: 26px;">${tandemCreatorName} proposed a Tandem to you on talkEasy!</span></span>
      </p>
  </div>
  ...
  >
    <tr>
      ...
      >
        <a
           href="${process.env.BASE_URL}/tandem/all" style="background:#F57816;color:#FFFFFF;font-family:Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank"
        >
          See all my Tandems
        </a>
      </td>
