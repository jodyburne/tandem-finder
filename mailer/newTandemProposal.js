...
@media only screen and (max-width:480px) {
  ...
  >
    <tr>
      ...
      >
        <a
           href="http://localhost:3005/tandem/all" style="background:#F57816;color:#FFFFFF;font-family:Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank"
        >
          See all my Tandems
        </a>
      </td>
